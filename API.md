...
```lua
{
	caption = "Creative Mode", -- Caption for gamemode (required)
	pages = {"sfinv:crafting"}, -- sfinv pages to show in inventory (by page name)
	page_mods = {"creative"}, -- sfinv pages to show in inventory (by page mod)
  ...
  hand = {
	...
	damage = false, -- Whether damage should be enabled for this gamemode
	breath = false, -- Whether breath should be enabled for this gamemode
